...
텍스트 테스트  
<input style="border:1px solid #BDBDBD;width:250px;" type="text" name="username" placeholder="사용자명" />
...
select 테스트   
<select>
  <option  value="apple"><span style="color:#070B19;">사과</span></option>
  <option style="color:#070B19;" value="banana">바나나</option>
  <option style="color:#070B19;" value="orange">오렌지</option>
</select>
