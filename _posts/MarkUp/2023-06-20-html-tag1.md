...
텍스트 테스트  
<input style="border:1px solid #BDBDBD;width:200px;" type="text" name="username" placeholder="사용자명" />
...
비밀번호 테스트      
<input style="border:1px solid #BDBDBD;" type="password" name="password" placeholder="비밀번호" />
...
날짜 선택 테스트  
<input style="border:1px solid #BDBDBD;" type="date" name="birthdate" />
...
숫자 입력 테스트  
<input style="border:1px solid #BDBDBD;" type="number" name="quantity" value="1" min="1" max="100" />

숫자입력은 초기값 1, 최소값 1, 최대값 100으로 설정했다.
...
이메일 입력 테스트  
<input style="border:1px solid #BDBDBD;" type="email" name="email" placeholder="이메일 주소" />
...
제출 버튼 테스트   
<input style="border:1px solid #BDBDBD;" type="submit" value="제출" />
